  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Service.messages.findById() instead.
        "prototype$__findById__messages": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Services/:id/messages/:fk",
          method: "GET"
        },

        // INTERNAL. Use Service.messages.destroyById() instead.
        ...
        // INTERNAL. Use Service.messages.updateById() instead.
        ...
        // INTERNAL. Use Service.messages() instead.
        "prototype$__get__messages": {
          isArray: true,
          url: urlBase + "/Services/:id/messages",
          method: "GET"
        },

        // INTERNAL. Use Service.messages.create() instead.
        "prototype$__create__messages": {
          url: urlBase + "/Services/:id/messages",
          method: "POST"
        },

        // INTERNAL. Use Service.messages.destroyAll() instead.
        "prototype$__delete__messages": {
          url: urlBase + "/Services/:id/messages",
          method: "DELETE"
        },

        // INTERNAL. Use Service.messages.count() instead.
        "prototype$__count__messages": {
          url: urlBase + "/Services/:id/messages/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Message.service() instead.
        "::get::Message::service": {
          url: urlBase + "/Messages/:id/service",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Service.messages
     * @header lbServices.Service.messages
     * @object
     * @description
     *
     * The object `Service.messages` groups methods
     * manipulating `Message` instances related to `Service`.
     *
     * Call {@link lbServices.Service#messages Service.messages()}
     ...
     */
        ...
        R.messages = function() {
          ...
          var action = TargetResource["::get::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#count
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
         * Counts messages of Service.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.messages.count = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::count::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#create
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.create = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::create::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#createMany
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.createMany = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::createMany::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#destroyAll
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.destroyAll = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::delete::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#destroyById
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.destroyById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::destroyById::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#findById
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.findById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::findById::Service::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Service.messages#updateById
         * @methodOf lbServices.Service.messages
         *
         * @description
         *
        ...
        R.messages.updateById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::updateById::Service::messages"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Service.messages.createMany() instead.
        "::createMany::Service::messages": {
          isArray: true,
          url: urlBase + "/Services/:id/messages",
          method: "POST"
        },
    ...
    */
    R.modelName = "Message";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Message#service
         * @methodOf lbServices.Message
         *
         * @description
         *
        ...
        R.service = function() {
          ...
          var action = TargetResource["::get::Message::service"];
          return action.apply(R, arguments);
        };
